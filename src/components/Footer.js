...
function Footer() {
  return (
    <div className="text-center myFoot">
      <hr />
      <h4 id="story" className="fw-bold">
        The Story Of Apostolic Impact Christian University.
      </h4>
      <p id="storyline" className="fw-bold text-secondary">
        The Institution was established for the purpose of training church
        leaders for the growth of their ministries across Africa and the World..
      </p>
      ...
      <p className="copy">
        Copyright (c) 2022. Apostolic Impact Christian University
      </p>
    </div>
  );
}
